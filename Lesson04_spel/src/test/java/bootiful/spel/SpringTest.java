...
class SpringTest {
    ...
    void beans() throws Exception {
        ...
        var collectionOfInventors = expressionParser
                .parseExpression("@registry.inventors")
                .getValue(sec, Collection.class);
        System.out.println(collectionOfInventors);

        //collectionOfInventors = null;
        //Assertions.assertNull(collectionOfInventors, "MENSAJE DE QUE LA ASSERTION falló");

        Assertions.assertNotNull(collectionOfInventors, "MENSAJE DE QUE LA ASSERTION falló");
    }
